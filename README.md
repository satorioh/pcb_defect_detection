...
The dataset folder contains the dataset used for this project, and its details in a README file inside the folders of template and defective PCB images. It contains RGB images of five types of bare PCBs. 
